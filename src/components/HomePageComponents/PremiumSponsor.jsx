...
const tempImage = "/matchbox-logo.png";

const PremiumSponsor = () => {
  return (
    <div className='w-full flex justify-center items-center text-center flex-col gap-y-4 mt-12'>
        <h1 className="fira-code font-bold text-[#e0bc6e] text-3xl md:text-3xl">
            <span className="uppercase text-[#e0bc6e] text-center">PROUD TO BE SPONSERED BY</span>
        </h1>
