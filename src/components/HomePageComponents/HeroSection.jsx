  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center mt-12 mb-10 relative z-10">
        ...
        />
        <button
          className="text-white text-lg bg-maroon border border-white rounded-md px-8 py-3 hover:bg-golden hover:text-maroon transition-all transform hover:scale-105 active:scale-95 font-semibold"
          ref={buttonRef} // Button animation ref
          onClick={handleRegisterClick}
        >
          Register Now
