              ...
              <div className="hidden lg:flex items-center">
                ...
                >
                  <Link to="/registration" aria-label="Register Now">
                    <button className="bg-maroon text-white px-4 py-2 rounded hover:bg-golden hover:text-maroon transition-all duration-300 ease-in-out transform hover:scale-105 font-semibold">
                      Register Now
                    </button>
                  </Link>
                </motion.div>
            ...
            {isMenuOpen && (
              ...
              >
                <div className="px-4 py-3 space-y-3">
                  ...
                  >
                    <Link to="/registration" aria-label="Register Now" className="bg-maroon text-white border border-white px-3 py-2 text-base font-medium block text-center hover:bg-golden hover:text-maroon transition-all duration-300 ease-in-out">
                      Register Now
                    </Link>
                  </motion.div>
                </div>
